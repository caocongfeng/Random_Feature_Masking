...
parser.add_argument("--wandbname", type=str, default="citeseeer_RMF")
parser.add_argument('--random_feature_masking',help='Random feature masking')
parser.add_argument("--temp", type=float, default=1.0, help="Temperature.")
parser.add_argument("--savename", type=str, default="result", help="save path")
...
if __name__ == '__main__':
    ...
    wandb.init(
        ...
        config={
            ...
            "architecture": "RFM_CCA_SSG",
            "dataset": args.dataname,
            "epochs": args.epochs,
            "temp": args.temp,
            "drop_edge_rate": args.der,
            "drop_feature_rate": args.dfr,
            "random_feature_masking": "random_feature_masking",
            "th_graph": "all",
            "random_feature_masking":args.random_feature_masking
        }
    )

    print('args',args)
    print('seed',th.initial_seed())
    print('='*30)
    ...
    # X = model.encoder.to(device)(graph.to(device),x.to(device))
    ...
    path='./'+args.savename+'/'+args.dataname+'/'+str(args.der)+"_"+str(args.dfr)+"_"+"MF"+'_'+formatted_time
    ...
    for epoch in range(2000):
        ...
        with th.no_grad():
            ...
            wandb.log({
                "liner_loss":loss.item(),
                "liner_train_acc": train_acc,

                "liner_epoch": epoch,
                "liner_val_acc": val_acc,
                "liner_test_acc":test_acc,
